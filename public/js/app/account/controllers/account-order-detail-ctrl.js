...
angular.module('ds.account')
    .controller('AccountOrderDetailCtrl', ['$scope', 'order', '$stateParams', 'GlobalData','$rootScope', '$timeout', '$uibModal',
        function($scope, order, $stateParams, GlobalData, $rootScope, $timeout,$uibModal) {
