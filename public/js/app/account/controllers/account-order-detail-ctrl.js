...
angular.module('ds.account')
    .controller('AccountOrderDetailCtrl', ['$scope', 'order', '$stateParams', 'GlobalData', '$rootScope', '$timeout','$modal',
        function($scope, order, $stateParams, GlobalData, $rootScope, $timeout,$modal) {
